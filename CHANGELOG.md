...
## [v0.0.1](https://github.com/maruloop/papion/commits/v0.0.1) - 2026-05-09
...
- feat: scan local workflow and action files (closes #67) by @maruloop in https://github.com/maruloop/papion/pull/68
- refactor(core): extract path package and centralise Windows normalisation by @maruloop in https://github.com/maruloop/papion/pull/76
- test(native): cover reusable workflow refs in native integration scenarios by @maruloop in https://github.com/maruloop/papion/pull/78
- feat(core)!: make SHA pinning mandatory; remove sha_pinning policy field by @maruloop in https://github.com/maruloop/papion/pull/79
